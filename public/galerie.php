...
<body>
    ...
    <main class="main">
        ...
        <p class="galerie__description">Les organisateurs de l'X-Trail vous offre la possibilité de télécharger ici toutes les photos prises par l'organisation et cela gratuitement.</p>
        <div class="galerie">
