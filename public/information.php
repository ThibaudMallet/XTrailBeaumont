...
<body>
    ...
    <main class="main">
        ...
        <h3 class="information__title">Le réglement</h3>
        <p class="information__reglement">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae possimus fuga quidem soluta, a molestias eum voluptatum iure enim consequuntur minus voluptates dolore ipsum facere ullam unde debitis? Provident, incidunt?
        Fugiat, reprehenderit amet. Laudantium vero numquam animi voluptas dicta ipsam doloremque harum dolore tenetur, in itaque officiis, voluptatum, hic ipsum laboriosam voluptatem illum repellendus autem suscipit voluptate magnam? Veniam, fugiat!
        Consectetur, error cupiditate. Quo cupiditate quas repellendus obcaecati id, quod iusto officia architecto voluptas, recusandae magnam quam temporibus porro amet facilis fuga ad! Sapiente placeat deleniti, perferendis nostrum labore assumenda.</p>
        <p class="information__reglement">Vous pouvez aussi retrouver le réglement en PDF ici : <a href="#">PDF</a></p>
        <h3 class="information__title">Les résultats</h3>
        ...
        <h3 class="information__title">FAQ</h3>
