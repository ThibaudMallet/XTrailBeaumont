...
<section class="caroussel__section">
    <div class="slider">
        <div class="slide-track">
            <div class="slide">
                <img src="./assets/pictures/logo/beaumontSurOiseLogo.png" height="80" width="150" alt="logo de la mairie de Beaumont sur Oise" />
            </div>
            <div class="slide">
                <img src="./assets/pictures/logo/intersport.svg" height="80" width="150" alt="logo d'Intersport" />
            </div>
            <div class="slide current-slide">
                <img src="./assets/pictures/logo/c2p.jpeg"" height="80" width="150" alt="logo de c2p" />
            </div>
            <div class="slide current-slide">
